function loadTableHome(data) {
    ...
    <div class="col-md-3">
        <div class="bg-success text-white shadow rounded">
            ...
            <div class="p-2"><span>Số lượng: </span> ${data.orderFinished}</div>
    ...
    <div class="col-md-3">
        <div class="bg-warning text-white shadow rounded">
            ...
            <div class="p-2"><span>Số lượng: </span> ${data.orderWarning}</div>
    ...
    <div class="col-md-3">
        <div class="bg-danger text-white shadow rounded">
            ...
            <div class="p-2"><span>Số lượng: </span> ${data.orderSuccess}</div>
    ...
    <div class="col-md-3">
        <div class="bg-secondary text-white shadow rounded">
            ...
            <div class="p-2"><span>Số lượng: </span> ${data.orderFailed}</div>
...
<div class="row mt-4">
    ...
    <div class="col-md-3">
        <div class="card text-dark bg-light">
            ...
            <div class="p-2"><span>Số lượng: </span> ${data.sumOrder}</div>
    ...
    <div class="col-md-3">
        <div class="card text-dark bg-light">
            ...
            <div class="p-2"><span>Số lượng: </span> ${data.sumUser}</div>
